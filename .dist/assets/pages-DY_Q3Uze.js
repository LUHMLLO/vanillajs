import{P as t,_ as o}from"./_error-BNIfY2us.js";const e=new t;e.SEO({icon:"",author:"lm",description:"Vanilla JS - Start Page",image:"",keywords:[""],title:"Start"});let a=String.raw;e.JS(a`
	import Drops from "/assets/js/drops.js";
	const drops = new Drops();
`);let n=String.raw;e.HTML(n`
	<grid max="4" demo>
		<column>
			<h1>Heading 1</h1>
		</column>
...
`);let i=String.raw;e.CSS(i``);const r=Object.freeze(Object.defineProperty({__proto__:null,page:e},Symbol.toStringTag,{value:"Module"})),c=new t;c.SEO({icon:"",author:"lm",description:"Vanilla JS - Component Previewer Page",image:"",keywords:[""],title:"Preview - Component Name Here"});let l=String.raw;c.JS(l``);let p=String.raw;c.HTML(p`<h1>Preview</h1>`);let d=String.raw;c.CSS(d``);const s=Object.freeze(Object.defineProperty({__proto__:null,page:c},Symbol.toStringTag,{value:"Module"})),u=new t;u.SEO({icon:"",author:"lm",description:"Vanilla JS - Proposal Tool About Page",image:"",keywords:[""],title:"Proposal Tool - About"});let m=String.raw;u.JS(m``);let g=String.raw;u.HTML(g`<h1>Proposal About</h1>`);let _=String.raw;u.CSS(_``);const b=Object.freeze(Object.defineProperty({__proto__:null,page:u},Symbol.toStringTag,{value:"Module"})),h=new t;h.SEO({icon:"/assets/img/gizmo.svg",author:"lm",description:"Vanilla JS - Proposal Tool Demo Page",image:"",keywords:[""],title:"Proposal Tool - Demo"});let f=String.raw;h.JS(f`
	import Drops from "/assets/js/drops.js";
...
`);let v=String.raw;h.HTML(v`
			...
			<row class="align --center gap --5xs justify --end">
				...
				<nav data-variant="pill">
					<dropdown data-variant="wrapper">
						...
						<dialog data-role="dropmenu" data-position="bottom">
							<component__header>
								<icon type="button" data-trigger="close">close</icon>
							</component__header>
	...
	<overlays>
		...
		<dialog id="command-palette" class="w --max">
			<component__header class="gap --5xl">
				<icon>keyboard_command_key</icon>
...
`);const y=Object.freeze(Object.defineProperty({__proto__:null,page:h},Symbol.toStringTag,{value:"Module"})),w=new t;w.SEO({icon:"",author:"lm",description:"Vanilla JS - Proposal Tool About Help",image:"",keywords:[""],title:"Proposal Tool - Help"});let k=String.raw;w.JS(k``);let S=String.raw;w.HTML(S`<h1>Proposal Help</h1>`);let j=String.raw;w.CSS(j``);const P=[{path:"/error","import":o},{path:"/","import":r},{path:"/preview","import":s},{path:"/proposal/about","import":b},{path:"/proposal","import":y},{path:"/proposal/help","import":Object.freeze(Object.defineProperty({__proto__:null,page:w},Symbol.toStringTag,{value:"Module"}))}];export{P as default};
